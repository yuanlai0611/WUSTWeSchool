...
public class dean_office_fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle saveInstanceState){
        ...
        adapter.setmOnItemClickListener(new Element_item_Adapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, final int position) {
                ...
                mCustomPopupWindow = new CustomPopupWindow(v.findViewById(R.id.test_4),
                ...
                mCustomPopupWindow.setOnPopupWindowListener(new CustomPopupWindow
                    ...
                    public void initView() {
                        mImageButton = (Button) mLayoutPopupWindowView.findViewById(R.id
                                .i_know);
                        mImageButton.setOnClickListener(dean_office_fragment.this);

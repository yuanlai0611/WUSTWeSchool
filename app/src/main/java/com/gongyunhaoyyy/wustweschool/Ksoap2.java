...
//        String methodName = "xslogin";
    ...
    public static String chooseCourse(String xh) {
        ...
        SoapObject localSoapObject = new SoapObject("http://webservices.qzdatasoft.com", "xsxk");
        localSoapObject.addProperty("in0", xh);
        localSoapObject.addProperty("in1", time);
        localSoapObject.addProperty("in2", chkvalue);
